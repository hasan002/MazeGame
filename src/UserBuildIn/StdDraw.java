 ...
 * enabling computer animations. The following methods control the way in which
 * objects are drawn:
 * <ul>
 ...
 * call a drawing method&mdash;such as {@code point()} or
 * {@code line()}&mdash;the results appear on the screen.
 * <p>
 ...
 * draw, and then drawing them all
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * <tt>StdDraw.DARK_GRAY</tt>, <tt>StdDraw.GRAY</tt>,
     * <tt>StdDraw.GREEN</tt>,
     * <tt>StdDraw.LIGHT_GRAY</tt>, <tt>StdDraw.MAGENTA</tt>,
     * <tt>StdDraw.ORANGE</tt>,
    ...
    public static void text2(double x, double y, String text) {
        if (text == null) {
            throw new NullPointerException();
        }
         Font font = new Font("Blackadder ITC", Font.PLAIN, 50);
        offscreen.setFont(font);
        FontMetrics metrics = offscreen.getFontMetrics();
        double xs = scaleX(x);
        double ys = scaleY(y);
    ...
    public static void text3(double x, double y, String text) {
        if (text == null) {
            throw new NullPointerException();
        }
